...
// Simple Examples
//go:generate runtemplate -tpl simple/list.tpl       Prefix=Simple Type=int    Stringer:true  Comparable:true Ordered:true  Integer:true MapTo:string MapTo:int64
...
//go:generate runtemplate -tpl simple/set.tpl        Prefix=Simple Type=int    Stringer:true  Ordered:true  Integer:true                 MapTo:string MapTo:int64
...
// Immutable Examples
//go:generate runtemplate -tpl immutable/collection.tpl Prefix=Immutable Type=int    Stringer:true  Comparable:true Ordered:true Integer:true MapTo:string MapTo:int64
//go:generate runtemplate -tpl immutable/collection.tpl Prefix=Immutable Type=Apple  Stringer:false                                           MapTo:string
//go:generate runtemplate -tpl immutable/list.tpl       Prefix=Immutable Type=int    Stringer:true  Comparable:true Ordered:true Integer:true MapTo:string MapTo:int64
...
//go:generate runtemplate -tpl immutable/set.tpl        Prefix=Immutable Type=int    Stringer:true                  Ordered:true Integer:true MapTo:string MapTo:int64
...
// Fast Examples
//go:generate runtemplate -tpl fast/collection.tpl Prefix=Fast Type=int    Stringer:true Comparable:true Ordered:true Integer:true
//go:generate runtemplate -tpl fast/collection.tpl Prefix=Fast Type=Apple  Stringer:false
//go:generate runtemplate -tpl fast/list.tpl       Prefix=Fast Type=int    Stringer:true  Comparable:true Ordered:true  Integer:true MapTo:string MapTo:int64
...
//go:generate runtemplate -tpl fast/set.tpl        Prefix=Fast Type=int    Stringer:true                  Ordered:true  Integer:true MapTo:string MapTo:int64
...
// Threadsafe Examples
//go:generate runtemplate -tpl threadsafe/collection.tpl Type=int    Stringer:true  Comparable:true Ordered:true Integer:true MapTo:string MapTo:int64
//go:generate runtemplate -tpl threadsafe/collection.tpl Type=Apple  Stringer:false                                           MapTo:string
//go:generate runtemplate -tpl threadsafe/list.tpl       Type=int    Stringer:true  Comparable:true Ordered:true Integer:true MapTo:string MapTo:int64
...
//go:generate runtemplate -tpl threadsafe/set.tpl        Type=int    Stringer:true                  Ordered:true Integer:true MapTo:string MapTo:int64
