...
type FastIntCollection interface {
	...
	// Exists verifies that one or more elements of FastIntCollection return true for the passed func.
	Exists(fn func(int) bool) bool

	// Forall verifies that all elements of FastIntCollection return true for the passed func.
	Forall(fn func(int) bool) bool

	// Foreach iterates over FastIntCollection and executes the passed func against each element.
	Foreach(fn func(int))
