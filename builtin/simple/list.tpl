...
// Build{{.Type}}ListFromChan constructs a new {{.UPrefix}}{{.UType}}List from a channel that supplies a sequence
// of values until it is closed. The function doesn't return until then.
func Build{{.Type}}ListFromChan(source <-chan {{.PType}}) {{.UPrefix}}{{.UType}}List {
...
func (list {{.UPrefix}}{{.UType}}List) Min() {{.PType}} {
...
// Panics if the collection is empty.
func (list {{.UPrefix}}{{.UType}}List) Max() (result {{.PType}}) {
