...
//go:generate runtemplate -tpl collections/collection.tpl -output x_apple_collection.go Type=Apple Stringer=false
...
//go:generate runtemplate -tpl collections/list.tpl -output x_apple_list.go Type=Apple Stringer=false Comparable=true
...
//go:generate runtemplate -tpl collections/set.tpl -output x_apple_set.go Type=Apple Stringer=false
