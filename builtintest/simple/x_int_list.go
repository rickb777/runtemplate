...
// XIntList is a slice of type int. Use it where you would use []int.
...
func (list XIntList) Tail() XIntList {
	return XIntList(list[1:])
}

// Init gets everything except the last. Init plus Last include the whole list. Init is the opposite of Tail.
// Panics if list is empty
func (list XIntList) Init() XIntList {
	return XIntList(list[:list.Len()-1])
}
...
// This is one of the three methods in the standard sort.Interface.
func (list XIntList) Swap(i, j int) {
...
// MinBy returns an element of XIntList containing the minimum value, when compared to other elements
// using a passed func defining ‘less’. In the case of multiple items being equally minimal, the first such
// element is returned. Panics if there are no elements.
func (list XIntList) MinBy(less func(int, int) bool) int {
	l := list.Len()
	if l == 0 {
...
// MaxBy returns an element of XIntList containing the maximum value, when compared to other elements
// using a passed func defining ‘less’. In the case of multiple items being equally maximal, the first such
// element is returned. Panics if there are no elements.
func (list XIntList) MaxBy(less func(int, int) bool) int {
	l := list.Len()
	if l == 0 {
