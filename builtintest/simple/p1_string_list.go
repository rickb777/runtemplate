...
func (list P1StringList) Init() P1StringList {
	return P1StringList(list[:len(list)-1])
}
...
func (list P1StringList) Filter(fn func(*string) bool) P1StringList {
	result := newP1StringList(0, len(list)/2)
...
func (list P1StringList) Partition(p func(*string) bool) (P1StringList, P1StringList) {
	matching := newP1StringList(0, len(list)/2)
	others := newP1StringList(0, len(list)/2)
...
// Transform returns a new P1StringList by transforming every element with a function fn.
// The original list is not modified.
//
// This is a domain-to-range mapping function. For bespoke transformations to other types, copy and modify
// this method appropriately.
func (list P1StringList) Transform(fn func(*string) *string) P1StringList {
	result := newP1StringList(0, len(list))
