...
//go:generate runtemplate -tpl threadsafe/collection.tpl Prefix=X1 Type=int             ToList:true ToSet:true Stringer:true Comparable:true Ordered:true Integer:true MapTo:string MapTo:int64
...
//go:generate runtemplate -tpl threadsafe/list.tpl       Prefix=X1 Type=int             ToSet:true  Stringer:true  Comparable:true Ordered:true  Integer:true GobEncode:true JsonEncode:true MapTo:string MapTo:int64
...
//go:generate runtemplate -tpl threadsafe/set.tpl        Prefix=X1 Type=int             ToList:true  Stringer:true  Ordered:true  Integer:true GobEncode:true JsonEncode:true                MapTo:string MapTo:int64
...
//go:generate runtemplate -tpl threadsafe/map.tpl        Prefix=TX1 Key=int             Type=int     Comparable:true Stringer:true Integer:true GobEncode:true JsonEncode:true
...
//go:generate runtemplate -tpl threadsafe/queue.tpl      Prefix=X1 Type=string          ToList:true ToSet:true  Stringer:true  Comparable:true Ordered:false Integer:false
//go:generate runtemplate -tpl threadsafe/queue.tpl      Prefix=X1 Type=int             ToList:true ToSet:true  Stringer:true  Comparable:true Ordered:true  Integer:true  MapTo:string MapTo:int64
