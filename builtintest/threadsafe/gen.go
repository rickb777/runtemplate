...
//go:generate runtemplate -tpl threadsafe/collection.tpl Prefix=X1 Type=int     ToSet:true Stringer:true Comparable:true Ordered:true Numeric:true
...
//go:generate runtemplate -tpl threadsafe/list.tpl       Prefix=X1 Type=int     ToSet:true  Stringer:true  Comparable:true Ordered:true  Numeric:true GobEncode:true JsonEncode:true
//go:generate runtemplate -tpl threadsafe/list.tpl       Prefix=X1 Type=Apple   ToSet:true  Stringer:false Comparable:true
//go:generate runtemplate -tpl threadsafe/list.tpl       Prefix=X2 Type=big.Int ToSet:false Import:"math/big"
...
//go:generate runtemplate -tpl threadsafe/set.tpl        Prefix=X1 Type=int     ToList:true  Stringer:true  Ordered:true  Numeric:true GobEncode:true JsonEncode:true
...
//go:generate runtemplate -tpl threadsafe/queue.tpl      Prefix=X1 Type=int     ToList:true ToSet:true  Stringer:true  Comparable:true Ordered:true  Numeric:true
...
//go:generate runtemplate -tpl threadsafe/queue.tpl      Prefix=X2 Type=big.Int ToList:true ToSet:false Import:"math/big"
