...
// P1IntList contains a slice of type *int. Use it where you would use []*int.
// To add items to the list, simply use the normal built-in append function.
// List values follow a similar pattern to Scala Lists and LinearSeqs in particular.
// Importantly, *none of its methods ever mutate a list*; they merely return new lists where required.
// When a list needs mutating, use normal Go slice operations, e.g. *append()*.
// For comparison with Scala, see e.g. http://www.scala-lang.org/api/2.11.7/#scala.collection.LinearSeq
type P1IntList struct {
	s *sync.RWMutex
	m []*int
}
...
// Foreach iterates over P1IntList and executes function fn against each element.
...
func (list *P1IntList) Add(more ...*int) {
	list.Append(more...)
}

// Append adds items to the current list, returning the modified list.
func (list *P1IntList) Append(more ...*int) *P1IntList {
	list.s.Lock()
	defer list.s.Unlock()
	return list.doAppend(more...)
}

func (list *P1IntList) doAppend(more ...*int) *P1IntList {
	list.m = append(list.m, more...)
	return list
}

// DoInsertAt modifies a P1IntList by inserting elements at a given index.
// This is a generalised version of Append.
//
// The modified list is returned.
// Panics if the index is out of range.
func (list *P1IntList) DoInsertAt(index int, more ...*int) *P1IntList {
	list.s.Lock()
	defer list.s.Unlock()
...
// DoDeleteFirst modifies a P1IntList by deleting n elements from the start of
// the list.
//
// The modified list is returned.
// Panics if n is large enough to take the index out of range.
func (list *P1IntList) DoDeleteFirst(n int) *P1IntList {
	list.s.Lock()
	defer list.s.Unlock()
    return list.doDeleteAt(0, n)
}

// DoDeleteLast modifies a P1IntList by deleting n elements from the end of
// the list.
//
// The modified list is returned.
// Panics if n is large enough to take the index out of range.
func (list *P1IntList) DoDeleteLast(n int) *P1IntList {
	list.s.Lock()
	defer list.s.Unlock()
    return list.doDeleteAt(len(list.m)-n, n)
}

// DoDeleteAt modifies a P1IntList by deleting n elements from a given index.
//
// The modified list is returned.
// Panics if the index is out of range or n is large enough to take the index out of range.
func (list *P1IntList) DoDeleteAt(index, n int) *P1IntList {
	list.s.Lock()
	defer list.s.Unlock()
...
// DoKeepWhere modifies a P1IntList by retaining only those elements that match
// the predicate p. This is very similar to Filter but alters the list in place.
//
// The modified list is returned.
func (list *P1IntList) DoKeepWhere(p func(*int) bool) *P1IntList {
	list.s.Lock()
	defer list.s.Unlock()
...
func (list *P1IntList) Filter(p func(*int) bool) *P1IntList {
	...
	result := newP1IntList(0, len(list.m)/2)
...
func (list *P1IntList) Partition(p func(*int) bool) (*P1IntList, *P1IntList) {
	...
	matching := newP1IntList(0, len(list.m)/2)
	others := newP1IntList(0, len(list.m)/2)
...
// Map returns a new P1IntList by transforming every element with a function fn.
// The resulting list is the same size as the original list.
// The original list is not modified.
//
// This is a domain-to-range mapping function. For bespoke transformations to other types, copy and modify
// this method appropriately.
func (list *P1IntList) Map(fn func(*int) *int) *P1IntList {
	result := newP1IntList(len(list.m), len(list.m))
	list.s.RLock()
	defer list.s.RUnlock()
...
// FlatMap returns a new P1IntList by transforming every element with a function fn that
// returns zero or more items in a slice. The resulting list may have a different size to the original list.
// The original list is not modified.
//
// This is a domain-to-range mapping function. For bespoke transformations to other types, copy and modify
// this method appropriately.
func (list *P1IntList) FlatMap(fn func(*int) []*int) *P1IntList {
	result := newP1IntList(0, len(list.m))
	list.s.RLock()
	defer list.s.RUnlock()
...
func (list *P1IntList) SortBy(less func(i, j *int) bool) *P1IntList {
	...
	sort.Sort(sortableP1IntList{less, list.m})
	return list
}
...
func (list *P1IntList) StableSortBy(less func(i, j *int) bool) *P1IntList {
	...
	sort.Stable(sortableP1IntList{less, list.m})
	return list
}
...
func (list P1IntList) MarshalJSON() ([]byte, error) {
