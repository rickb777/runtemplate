...
type P1IntCollection interface {
	...
	// Exists verifies that one or more elements of P1IntCollection return true for the passed func.
	Exists(fn func(*int) bool) bool

	// Forall verifies that all elements of P1IntCollection return true for the passed func.
	Forall(fn func(*int) bool) bool

	// Foreach iterates over P1IntCollection and executes the passed func against each element.
	Foreach(fn func(*int))
	...
	// CountBy gives the number elements of P1IntCollection that return true for the passed predicate.
