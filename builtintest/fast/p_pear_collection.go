...
type PPearCollection interface {
	...
	// NonEmpty tests whether PPearCollection is empty.
	NonEmpty() bool
	...
	// Forall verifies that all elements of PPearCollection return true for the passed func.
	Forall(fn func(*Pear) bool) bool

	// Foreach iterates over PPearCollection and executes the passed func against each element.
	...
	// MaxBy returns an element of PPearCollection containing the maximum value, when compared to other elements
