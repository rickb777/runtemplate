...
//go:generate runtemplate -tpl fast/collection.tpl Prefix=X1 Type=string          ToList:true ToSet:true Stringer:true Comparable:true
//go:generate runtemplate -tpl fast/collection.tpl Prefix=X1 Type=int             ToList:true ToSet:true Stringer:true Comparable:true Ordered:true Integer:true MapTo:string MapTo:int64
//go:generate runtemplate -tpl fast/collection.tpl Prefix=X1 Type=Apple
//go:generate runtemplate -tpl fast/collection.tpl Prefix=X1 Type=Pear
//go:generate runtemplate -tpl fast/collection.tpl Prefix=X1 Type=url.URL         ToList:true ToSet:true  Stringer:true Comparable:true Import:"net/url"
//go:generate runtemplate -tpl fast/collection.tpl Prefix=X1 Type=big.Int/Integer ToList:true ToSet:false Stringer:true                 Import:"math/big"
...
//go:generate runtemplate -tpl fast/list.tpl       Prefix=X1 Type=int             ToSet:true  Stringer:true  Comparable:true Ordered:true  Integer:true GobEncode:true JsonEncode:true MapTo:string MapTo:int64
//go:generate runtemplate -tpl fast/list.tpl       Prefix=X1 Type=url.URL         ToSet:true  Stringer:true  Comparable:true StringParser:url.Parse Import:"net/url"
//go:generate runtemplate -tpl fast/list.tpl       Prefix=X1 Type=big.Int/Integer ToSet:false Stringer:true  Import:"math/big"                                          MapTo:string MapTo:int
...
//go:generate runtemplate -tpl fast/set.tpl        Prefix=X1 Type=int             ToList:true  Stringer:true  Ordered:true  Integer:true GobEncode:true JsonEncode:true                MapTo:string MapTo:int64
//go:generate runtemplate -tpl fast/set.tpl        Prefix=X1 Type=url.URL         ToList:true  Stringer:true  Comparable:true StringParser:url.Parse Import:"net/url"
//go:generate runtemplate -tpl fast/set.tpl        Prefix=X1 Type=testtypes.Email Import:"github.com/rickb777/runtemplate/v3/builtintest/testtypes"

//go:generate runtemplate -tpl fast/map.tpl        Prefix=TX1 Key=int             Type=int     Comparable:true Stringer:true Integer:true GobEncode:true JsonEncode:true
...
//go:generate runtemplate -tpl fast/queue.tpl      Prefix=X1 Type=string          ToList:true ToSet:true  Stringer:true  Comparable:true Ordered:false Integer:false
//go:generate runtemplate -tpl fast/queue.tpl      Prefix=X1 Type=int             ToList:true ToSet:true  Stringer:true  Comparable:true Ordered:true  Integer:true  MapTo:string MapTo:int64
//go:generate runtemplate -tpl fast/queue.tpl      Prefix=X1 Type=url.URL         ToList:true ToSet:true  Stringer:true  Comparable:true Import:"net/url"
//go:generate runtemplate -tpl fast/queue.tpl      Prefix=X1 Type=big.Int/Integer ToList:true ToSet:false Import:"math/big"                                          MapTo:string MapTo:int
