...
//go:generate runtemplate -tpl simple/collection.tpl Prefix=P2 Type=*big.Int/Integer Import:"math/big"

//go:generate runtemplate -tpl simple/list.tpl       Prefix=P1 Type=*string          ToSet:true Stringer:true  Comparable:true Ordered:false Numeric:false
...
//go:generate runtemplate -tpl simple/list.tpl       Prefix=P2 Type=*big.Int/Integer Import:"math/big"
