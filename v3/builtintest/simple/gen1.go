...
//go:generate runtemplate -tpl simple/list.tpl       Prefix=X1 Type=big.Int/Integer ToSet:false Import:"math/big"                                          MapTo:string MapTo:int
...
//go:generate runtemplate -tpl simple/set.tpl        Prefix=X2 Type=testtypes.Email Import:"github.com/johanbrandhorst/runtemplate/v3/builtintest/testtypes"
