...
// P2BigIntList is a slice of type *big.Int. Use it where you would use []*big.Int.
// To add items to the list, simply use the normal built-in append function.
//
// List values follow a similar pattern to Scala Lists and LinearSeqs in particular.
// For comparison with Scala, see e.g. http://www.scala-lang.org/api/2.11.7/#scala.collection.LinearSeq
type P2BigIntList []*big.Int
...
func MakeP2BigIntList(length, capacity int) P2BigIntList {
	return make(P2BigIntList, length, capacity)
}
...
// BuildP2BigIntListFromChan constructs a new P2BigIntList from a channel that supplies a sequence
...
func (list P2BigIntList) Filter(p func(*big.Int) bool) P2BigIntList {
	result := MakeP2BigIntList(0, len(list))
...
func (list P2BigIntList) Partition(p func(*big.Int) bool) (P2BigIntList, P2BigIntList) {
	matching := MakeP2BigIntList(0, len(list))
	others := MakeP2BigIntList(0, len(list))
...
func (list P2BigIntList) SortBy(less func(i, j *big.Int) bool) P2BigIntList {
	...
	sort.Sort(sortableP2BigIntList{less, list})
	return list
}
...
func (list P2BigIntList) StableSortBy(less func(i, j *big.Int) bool) P2BigIntList {
	...
	sort.Stable(sortableP2BigIntList{less, list})
	return list
}
