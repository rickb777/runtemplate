// An encapsulated immutable map[url.URL]struct{} used as a set.
// Thread-safe.
//
//
...
func (set *X2UrlURLSet) Remove(i url.URL) *X2UrlURLSet {
	if set == nil {
		return nil
	}
...
// Foreach iterates over url.URLSet and executes the function f against each element.
