...
// X2BigIntList contains a slice of type big.Int. It is designed
...
func newX2BigIntList(length, capacity int) *X2BigIntList {
	return &X2BigIntList {
...
func NewX2BigIntList(values ...big.Int) *X2BigIntList {
	list := newX2BigIntList(len(values), len(values))
	copy(list.m, values)
	return list
}
...
func ConvertX2BigIntList(values ...interface{}) (*X2BigIntList, bool) {
	list := newX2BigIntList(0, len(values))
...
func (list *X2BigIntList) Append(more ...big.Int) *X2BigIntList {
	if list == nil {
		...
		return NewX2BigIntList(more...)
	}

	newList := NewX2BigIntList(list.m...)
	newList.doAppend(more...)
	return newList
}

func (list *X2BigIntList) doAppend(more ...big.Int) {
...
func (list *X2BigIntList) Filter(p func(big.Int) bool) *X2BigIntList {
	...
	result := newX2BigIntList(0, len(list.m)/2)
...
func (list *X2BigIntList) Partition(p func(big.Int) bool) (*X2BigIntList, *X2BigIntList) {
	...
	matching := newX2BigIntList(0, len(list.m)/2)
	others := newX2BigIntList(0, len(list.m)/2)
...
func (list *X2BigIntList) Map(f func(big.Int) big.Int) *X2BigIntList {
	...
	result := newX2BigIntList(len(list.m), len(list.m))
...
func (list *X2BigIntList) FlatMap(f func(big.Int) []big.Int) *X2BigIntList {
	...
	result := newX2BigIntList(0, len(list.m))
...
func (list *X2BigIntList) SortBy(less func(i, j big.Int) bool) *X2BigIntList {
	...
	result := NewX2BigIntList(list.m...)
	sort.Sort(sortableX2BigIntList{less, result.m})
	return result
}
...
func (list *X2BigIntList) StableSortBy(less func(i, j big.Int) bool) *X2BigIntList {
	...
	result := NewX2BigIntList(list.m...)
	sort.Stable(sortableX2BigIntList{less, result.m})
	return result
}
