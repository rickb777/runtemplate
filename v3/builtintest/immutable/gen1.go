...
//go:generate runtemplate -tpl immutable/collection.tpl Prefix=X1 Type=int             ToList:true ToSet:true Stringer:true Comparable:true Ordered:true Numeric:true MapTo:string MapTo:int64
//go:generate runtemplate -tpl immutable/collection.tpl Prefix=X1 Type=Apple           ToList:true ToSet:true Stringer:false
...
//go:generate runtemplate -tpl immutable/set.tpl        Prefix=X2 Type=testtypes.Email Import:"github.com/rickb777/runtemplate/v3/builtintest/testtypes"
