...
//go:generate runtemplate -tpl immutable/list.tpl       Prefix=X1 Type=big.Int/Integer ToSet:false Import:"math/big"                                          MapTo:string MapTo:int
...
//go:generate runtemplate -tpl immutable/set.tpl        Prefix=X2 Type=testtypes.Email Import:"github.com/johanbrandhorst/runtemplate/v3/builtintest/testtypes"
