// An encapsulated immutable map[Name]struct{} used as a set.
// Thread-safe.
//
//
// Generated from immutable/set.tpl with Type=Name
...
func (set *X1NameSet) Remove(i Name) *X1NameSet {
	if set == nil {
		return nil
	}
...
// Foreach iterates over NameSet and executes the function f against each element.
...
// Partition returns two new NameSets whose elements return true or false for the predicate, p.
