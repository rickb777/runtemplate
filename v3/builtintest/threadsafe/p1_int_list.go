...
func (list *P1IntList) Filter(p func(*int) bool) *P1IntList {
	...
	result := MakeP1IntList(0, len(list.m))
...
// Partition returns two new P1IntLists whose elements return true or false for the predicate, p.
...
func (list *P1IntList) Partition(p func(*int) bool) (*P1IntList, *P1IntList) {
	...
	matching := MakeP1IntList(0, len(list.m))
	others := MakeP1IntList(0, len(list.m))
...
func (list *P1IntList) Map(f func(*int) *int) *P1IntList {
	...
	result := MakeP1IntList(len(list.m), len(list.m))
	list.s.RLock()
	defer list.s.RUnlock()
...
func (list *P1IntList) Fold(initial *int, fn func(*int, *int) *int) *int {
	list.s.RLock()
	defer list.s.RUnlock()
...
func (list *P1IntList) UnmarshalJSON(b []byte) error {
	list.s.Lock()
	defer list.s.Unlock()
