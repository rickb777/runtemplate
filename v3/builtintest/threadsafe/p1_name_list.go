...
// Thread-safe.
//
// Generated from threadsafe/list.tpl with Type=*Name
...
func (list *P1NameList) Fold(initial *Name, fn func(*Name, *Name) *Name) *Name {
	list.s.RLock()
	defer list.s.RUnlock()
...
func (list P1NameList) mkString3Bytes(before, between, after string) *strings.Builder {
	b := &strings.Builder{}
