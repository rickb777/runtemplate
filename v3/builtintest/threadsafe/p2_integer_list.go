...
func (list *P2IntegerList) Clone() *P2IntegerList {
	...
	return NewP2IntegerList(list.m...)
}
...
func (list *P2IntegerList) Add(more ...*big.Int) {
	list.Append(more...)
}
...
func (list *P2IntegerList) Append(more ...*big.Int) *P2IntegerList {
	if list == nil {
		if len(more) == 0 {
			return nil
		}
		list = MakeP2IntegerList(0, len(more))
	}
...
func (list *P2IntegerList) doAppend(more ...*big.Int) *P2IntegerList {
	list.m = append(list.m, more...)
	return list
}

// DoInsertAt modifies a P2IntegerList by inserting elements at a given index.
// This is a generalised version of Append.
//
// If the list is nil, a new list is allocated and returned. Otherwise the modified list is returned.
// Panics if the index is out of range.
func (list *P2IntegerList) DoInsertAt(index int, more ...*big.Int) *P2IntegerList {
	if list == nil {
		if len(more) == 0 {
			return nil
		}
...
// DoDeleteFirst modifies a P2IntegerList by deleting n elements from the start of
// the list.
//
// If the list is nil, a new list is allocated and returned. Otherwise the modified list is returned.
// Panics if n is large enough to take the index out of range.
func (list *P2IntegerList) DoDeleteFirst(n int) *P2IntegerList {
	list.s.Lock()
	defer list.s.Unlock()
	return list.doDeleteAt(0, n)
}

// DoDeleteLast modifies a P2IntegerList by deleting n elements from the end of
// the list.
//
// The list is modified and the modified list is returned.
// Panics if n is large enough to take the index out of range.
func (list *P2IntegerList) DoDeleteLast(n int) *P2IntegerList {
	list.s.Lock()
	defer list.s.Unlock()
	return list.doDeleteAt(len(list.m)-n, n)
}

// DoDeleteAt modifies a P2IntegerList by deleting n elements from a given index.
//
// The list is modified and the modified list is returned.
// Panics if the index is out of range or n is large enough to take the index out of range.
func (list *P2IntegerList) DoDeleteAt(index, n int) *P2IntegerList {
	list.s.Lock()
	defer list.s.Unlock()
...
// DoKeepWhere modifies a P2IntegerList by retaining only those elements that match
// the predicate p. This is very similar to Filter but alters the list in place.
//
// The list is modified and the modified list is returned.
func (list *P2IntegerList) DoKeepWhere(p func(*big.Int) bool) *P2IntegerList {
	if list == nil {
		return nil
	}
...
func (list *P2IntegerList) Filter(p func(*big.Int) bool) *P2IntegerList {
	...
	result := MakeP2IntegerList(0, len(list.m))
...
// Partition returns two new P2IntegerLists whose elements return true or false for the predicate, p.
...
func (list *P2IntegerList) Partition(p func(*big.Int) bool) (*P2IntegerList, *P2IntegerList) {
	...
	matching := MakeP2IntegerList(0, len(list.m))
	others := MakeP2IntegerList(0, len(list.m))
...
func (list *P2IntegerList) Map(f func(*big.Int) *big.Int) *P2IntegerList {
	...
	result := MakeP2IntegerList(len(list.m), len(list.m))
	list.s.RLock()
	defer list.s.RUnlock()
...
func (list *P2IntegerList) SortBy(less func(i, j *big.Int) bool) *P2IntegerList {
	...
	sort.Sort(sortableP2IntegerList{less, list.m})
	return list
}
