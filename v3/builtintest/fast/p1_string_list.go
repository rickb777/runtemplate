...
func (list *P1StringList) HeadOption() (*string, bool) {
	if list == nil {
		return nil, false
	}
...
// Otherwise returns nil.
func (list *P1StringList) LastOption() (*string, bool) {
	if list == nil {
		return nil, false
	}
...
func (list *P1StringList) Fold(initial *string, fn func(*string, *string) *string) *string {
