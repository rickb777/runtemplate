...
func (set *P1StringSet) Fold(initial *string, fn func(*string, *string) *string) *string {
...
func (set *P1StringSet) mkString3Bytes(before, between, after string) *strings.Builder {
	b := &strings.Builder{}
