...
//go:generate runtemplate -tpl fast/collection.tpl Prefix=P1 Type=*Apple           ToList:true ToSet:true Stringer:false
//go:generate runtemplate -tpl fast/collection.tpl Prefix=P1 Type=*Pear
//go:generate runtemplate -tpl fast/collection.tpl Prefix=P2 Type=*big.Int/Integer ToList:true ToSet:false Stringer:true Import:"math/big"

//go:generate runtemplate -tpl fast/list.tpl       Prefix=P1 Type=*string          ToSet:true  Stringer:true  Comparable:true Ordered:false StringLike:false
//go:generate runtemplate -tpl fast/list.tpl       Prefix=P1 Type=*Name            ToSet:true  Stringer:true  Comparable:true Ordered:false StringLike:true
...
//go:generate runtemplate -tpl fast/list.tpl       Prefix=P2 Type=*big.Int/Integer ToSet:false Stringer:true Import:"math/big"

//go:generate runtemplate -tpl fast/set.tpl        Prefix=P1 Type=*string          ToList:true Stringer:true  Ordered:false StringLike:false
//go:generate runtemplate -tpl fast/set.tpl        Prefix=P1 Type=*Name            ToList:true Stringer:true  Ordered:false StringLike:false
