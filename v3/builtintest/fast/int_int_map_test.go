...
// options: Mutable:true Immutable:<no value> M:.slice()
...
func TestMuIntIntMapPop(t *testing.T) {
	a := NewTX1IntIntMap(TX1IntIntZip(1, 8, 2).Values(1, 2, 3)...)
...
func TestMuIntIntMapClone(t *testing.T) {
	a1 := NewTX1IntIntMap(TX1IntIntZip(1, 2).Values(9, 8)...)
	a2 := NewTX1IntIntMap(TX1IntIntZip(1, 2, 3).Values(9, 8, 7)...)
...
func TestIntMapMkString4(t *testing.T) {
