...
// NewP1IntQueue returns a new queue of *int. The behaviour when adding
...
func NewP1IntQueue(capacity int, overwrite bool) *P1IntQueue {
	return NewP1IntSortedQueue(capacity, overwrite, nil)
}

// NewP1IntSortedQueue returns a new queue of *int. The behaviour when adding
// to the queue depends on overwrite. If true, the push operation overwrites oldest values up to
// the space available, when the queue is full. Otherwise, it refuses to overfill the queue.
// If the 'less' comparison function is not nil, elements can be easily sorted.
func NewP1IntSortedQueue(capacity int, overwrite bool, less func(i, j *int) bool) *P1IntQueue {
	return &P1IntQueue{
		m:         make([]*int, capacity),
		read:      0,
		write:     0,
...
// BuildP1IntQueueFromChan constructs a new P1IntQueue from a channel that supplies
// a sequence of values until it is closed. The function doesn't return until then.
func BuildP1IntQueueFromChan(source <-chan *int) *P1IntQueue {
	queue := NewP1IntQueue(0, false)
	for v := range source {
...
func (queue *P1IntQueue) Reallocate(capacity int, overwrite bool) *P1IntQueue {
	if capacity < 1 {
...
func (queue *P1IntQueue) doReallocate(capacity int, overwrite bool) *P1IntQueue {
...
func (queue *P1IntQueue) Space() int {
	if queue == nil {
		return 0
	}
...
func (queue *P1IntQueue) IsSequence() bool {
	return true
}

// IsSet returns false for lists or queues.
func (queue *P1IntQueue) IsSet() bool {
	return false
}

// ToList returns the elements of the queue as a list. The returned list is a shallow
// copy; the queue is not altered.
func (queue *P1IntQueue) ToList() *P1IntList {
	if queue == nil {
		return nil
	}

	list := MakeP1IntList(queue.length, queue.length)
...
func (queue *P1IntQueue) toSlice(s []*int) []*int {
...
func (queue *P1IntQueue) ToInterfaceSlice() []interface{} {
	if queue == nil {
		return nil
	}
...
func (queue *P1IntQueue) Clone() *P1IntQueue {
	if queue == nil {
		return nil
	}
...
func (queue *P1IntQueue) Get(i int) *int {
...
func (queue *P1IntQueue) Head() *int {
...
func (queue *P1IntQueue) HeadOption() (*int, bool) {
	if queue == nil {
		return nil, false
	}
...
// Panics if queue is empty or nil.
func (queue *P1IntQueue) Last() *int {
...
func (queue *P1IntQueue) LastOption() (*int, bool) {
	if queue == nil {
		return nil, false
	}
...
func (queue *P1IntQueue) IsOverwriting() bool {
	if queue == nil {
		return false
	}
...
func (queue *P1IntQueue) IsFull() bool {
	if queue == nil {
		return false
	}
...
func (queue *P1IntQueue) IsEmpty() bool {
	if queue == nil {
		return true
	}
...
func (queue *P1IntQueue) NonEmpty() bool {
	if queue == nil {
		return false
	}
	return queue.length > 0
...
func (queue *P1IntQueue) Size() int {
	if queue == nil {
		return 0
	}
	return queue.length
...
func (queue *P1IntQueue) Len() int {
	return queue.Size()
}

// Swap swaps the elements with indexes i and j.
// The queue must not be empty.
func (queue *P1IntQueue) Swap(i, j int) {
	ri := (queue.read + i) % queue.capacity
...
// be empty.
func (queue *P1IntQueue) Less(i, j int) bool {
	ri := (queue.read + i) % queue.capacity
	rj := (queue.read + j) % queue.capacity
...
// (see NewP1IntSortedQueue).
func (queue *P1IntQueue) Sort() {
	sort.Sort(queue)
}
...
// This function will panic if the collection was created with a nil 'less' function
// (see NewP1IntSortedQueue).
func (queue *P1IntQueue) StableSort() {
	sort.Stable(queue)
}
...
func (queue *P1IntQueue) frontAndBack() ([]*int, []*int) {
...
func (queue *P1IntQueue) indexes() []int {
	if queue == nil || queue.length == 0 {
		return nil
	}
	if queue.write > queue.read {
...
func (queue *P1IntQueue) Add(more ...*int) {
	queue.Push(more...)
}
...
func (queue *P1IntQueue) Push(items ...*int) *P1IntQueue {
...
func (queue *P1IntQueue) Offer(items ...*int) []*int {
	return queue.doPush(items...)
}

func (queue *P1IntQueue) doPush(items ...*int) []*int {
	n := len(items)
...
func (queue *P1IntQueue) Pop1() (*int, bool) {
...
func (queue *P1IntQueue) Pop(n int) []*int {
	return queue.doPop(n)
}

func (queue *P1IntQueue) doPop(n int) []*int {
	if queue.length == 0 {
		return nil
	}
...
func (queue *P1IntQueue) Contains(v *int) bool {
...
func (queue *P1IntQueue) ContainsAll(i ...*int) bool {
	if queue == nil {
		return len(i) == 0
	}
...
// Exists verifies that one or more elements of P1IntQueue return true for the predicate p.
// The function should not alter the values via side-effects.
func (queue *P1IntQueue) Exists(p func(*int) bool) bool {
	if queue == nil {
		return false
	}
...
// Forall verifies that all elements of P1IntQueue return true for the predicate p.
// The function should not alter the values via side-effects.
func (queue *P1IntQueue) Forall(p func(*int) bool) bool {
	if queue == nil {
		return true
	}
...
// Foreach iterates over P1IntQueue and executes function f against each element.
// The function can safely alter the values via side-effects.
func (queue *P1IntQueue) Foreach(f func(*int)) {
	if queue == nil {
		return
	}
...
func (queue *P1IntQueue) Send() <-chan *int {
	ch := make(chan *int)
	go func() {
		if queue != nil {
...
// DoKeepWhere modifies a P1IntQueue by retaining only those elements that match
...
func (queue *P1IntQueue) DoKeepWhere(p func(*int) bool) *P1IntQueue {
	if queue == nil {
		return nil
	}
...
func (queue *P1IntQueue) Find(p func(*int) bool) (*int, bool) {
	if queue == nil {
		return nil, false
	}
...
// Filter returns a new P1IntQueue whose elements return true for predicate p.
//
// The original queue is not modified. See also DoKeepWhere (which does modify the original queue).
func (queue *P1IntQueue) Filter(p func(*int) bool) *P1IntQueue {
	if queue == nil {
		return nil
	}

	result := NewP1IntSortedQueue(queue.length, queue.overwrite, queue.less)
	i := 0
...
// Partition returns two new P1IntQueues whose elements return true or false for the predicate, p.
// The first result consists of all elements that satisfy the predicate and the second result consists of
// all elements that don't. The relative order of the elements in the results is the same as in the
// original queue.
//
// The original queue is not modified
func (queue *P1IntQueue) Partition(p func(*int) bool) (*P1IntQueue, *P1IntQueue) {
	if queue == nil {
		return nil, nil
	}

	matching := NewP1IntSortedQueue(queue.length, queue.overwrite, queue.less)
	others := NewP1IntSortedQueue(queue.length, queue.overwrite, queue.less)
	m, o := 0, 0
...
// Map returns a new P1IntQueue by transforming every element with function f.
// The resulting queue is the same size as the original queue.
// The original queue is not modified.
//
// This is a domain-to-range mapping function. For bespoke transformations to other types, copy and modify
// this method appropriately.
func (queue *P1IntQueue) Map(f func(*int) *int) *P1IntQueue {
	if queue == nil {
		return nil
	}
...
// FlatMap returns a new P1IntQueue by transforming every element with function f that
// returns zero or more items in a slice. The resulting queue may have a different size to the original queue.
// The original queue is not modified.
//
// This is a domain-to-range mapping function. For bespoke transformations to other types, copy and modify
// this method appropriately.
func (queue *P1IntQueue) FlatMap(f func(*int) []*int) *P1IntQueue {
	if queue == nil {
		return nil
	}
...
// CountBy gives the number elements of P1IntQueue that return true for the predicate p.
func (queue *P1IntQueue) CountBy(p func(*int) bool) (result int) {
	if queue == nil {
		return 0
	}
...
func (queue *P1IntQueue) Fold(initial *int, fn func(*int, *int) *int) *int {
	if queue == nil {
		return initial
	}
...
// MinBy returns an element of P1IntQueue containing the minimum value, when compared to other elements
// using a passed func defining ‘less’. In the case of multiple items being equally minimal, the first such
// element is returned. Panics if there are no elements.
func (queue *P1IntQueue) MinBy(less func(*int, *int) bool) *int {
...
// MaxBy returns an element of P1IntQueue containing the maximum value, when compared to other elements
// using a passed func defining ‘less’. In the case of multiple items being equally maximal, the first such
// element is returned. Panics if there are no elements.
func (queue *P1IntQueue) MaxBy(less func(*int, *int) bool) *int {
...
func (queue *P1IntQueue) Equals(other *P1IntQueue) bool {
	if queue == nil {
		if other == nil {
			return true
		}
...
// Panics if the collection is empty.
func (queue *P1IntQueue) Max() (result int) {
...
func (queue *P1IntQueue) StringList() []string {
	if queue == nil {
		return nil
	}
...
func (queue *P1IntQueue) String() string {
	return queue.MkString3("[", ", ", "]")
}

// MkString concatenates the values as a string using a supplied separator. No enclosing marks are added.
func (queue *P1IntQueue) MkString(sep string) string {
	return queue.MkString3("", sep, "")
}

// MkString3 concatenates the values as a string, using the prefix, separator and suffix supplied.
func (queue *P1IntQueue) MkString3(before, between, after string) string {
	if queue == nil {
		return ""
	}
...
func (queue *P1IntQueue) UnmarshalJSON(b []byte) error {

	return json.Unmarshal(b, &queue.m)
}

// MarshalJSON implements JSON encoding for this queue type.
func (queue P1IntQueue) MarshalJSON() ([]byte, error) {
