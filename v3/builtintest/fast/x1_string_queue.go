...
// X1StringQueue is a ring buffer containing a slice of type string. It is optimised
// for FIFO operations.
type X1StringQueue struct {
	m         []string
	read      int
	write     int
	length    int
...
// NewX1StringQueue returns a new queue of string. The behaviour when adding
...
func NewX1StringQueue(capacity int, overwrite bool) *X1StringQueue {
	return NewX1StringSortedQueue(capacity, overwrite, nil)
}

// NewX1StringSortedQueue returns a new queue of string. The behaviour when adding
// to the queue depends on overwrite. If true, the push operation overwrites oldest values up to
// the space available, when the queue is full. Otherwise, it refuses to overfill the queue.
// If the 'less' comparison function is not nil, elements can be easily sorted.
func NewX1StringSortedQueue(capacity int, overwrite bool, less func(i, j string) bool) *X1StringQueue {
	return &X1StringQueue{
...
// BuildX1StringQueueFromChan constructs a new X1StringQueue from a channel that supplies
// a sequence of values until it is closed. The function doesn't return until then.
func BuildX1StringQueueFromChan(source <-chan string) *X1StringQueue {
	queue := NewX1StringQueue(0, false)
	for v := range source {
...
func (queue *X1StringQueue) Reallocate(capacity int, overwrite bool) *X1StringQueue {
	if capacity < 1 {
...
func (queue *X1StringQueue) doReallocate(capacity int, overwrite bool) *X1StringQueue {
...
func (queue *X1StringQueue) Space() int {
	if queue == nil {
		return 0
	}
...
func (queue *X1StringQueue) Cap() int {
	if queue == nil {
		return 0
	}
...
func (queue *X1StringQueue) IsSequence() bool {
	return true
}

// IsSet returns false for lists or queues.
func (queue *X1StringQueue) IsSet() bool {
	return false
}

// ToList returns the elements of the queue as a list. The returned list is a shallow
// copy; the queue is not altered.
func (queue *X1StringQueue) ToList() *X1StringList {
	if queue == nil {
		return nil
	}

	list := MakeX1StringList(queue.length, queue.length)
...
func (queue *X1StringQueue) toSlice(s []string) []string {
...
func (queue *X1StringQueue) ToInterfaceSlice() []interface{} {
	if queue == nil {
		return nil
	}
...
func (queue *X1StringQueue) Clone() *X1StringQueue {
	if queue == nil {
		return nil
	}
...
func (queue *X1StringQueue) doClone(buffer []string) *X1StringQueue {
	w := 0
...
func (queue *X1StringQueue) Get(i int) string {
...
func (queue *X1StringQueue) Head() string {
...
func (queue *X1StringQueue) HeadOption() (string, bool) {
	if queue == nil {
		return "", false
	}
...
// Panics if queue is empty or nil.
func (queue *X1StringQueue) Last() string {
...
func (queue *X1StringQueue) LastOption() (string, bool) {
	if queue == nil {
		return "", false
	}
...
func (queue *X1StringQueue) IsOverwriting() bool {
	if queue == nil {
		return false
	}
...
func (queue *X1StringQueue) IsFull() bool {
	if queue == nil {
		return false
	}
...
func (queue *X1StringQueue) IsEmpty() bool {
	if queue == nil {
		return true
	}
...
func (queue *X1StringQueue) NonEmpty() bool {
	if queue == nil {
		return false
	}
	return queue.length > 0
...
func (queue *X1StringQueue) Size() int {
	if queue == nil {
		return 0
	}
	return queue.length
...
func (queue *X1StringQueue) Len() int {
	return queue.Size()
}

// Swap swaps the elements with indexes i and j.
// The queue must not be empty.
func (queue *X1StringQueue) Swap(i, j int) {
	ri := (queue.read + i) % queue.capacity
...
// be empty.
func (queue *X1StringQueue) Less(i, j int) bool {
	ri := (queue.read + i) % queue.capacity
	rj := (queue.read + j) % queue.capacity
...
// (see NewX1StringSortedQueue).
func (queue *X1StringQueue) Sort() {
	sort.Sort(queue)
}
...
// This function will panic if the collection was created with a nil 'less' function
// (see NewX1StringSortedQueue).
func (queue *X1StringQueue) StableSort() {
	sort.Stable(queue)
}
...
func (queue *X1StringQueue) frontAndBack() ([]string, []string) {
...
func (queue *X1StringQueue) indexes() []int {
	if queue == nil || queue.length == 0 {
		return nil
	}
	if queue.write > queue.read {
...
func (queue *X1StringQueue) Clear() {
	if queue != nil {
		queue.read = 0
		queue.write = 0
		queue.length = 0
...
func (queue *X1StringQueue) Add(more ...string) {
	queue.Push(more...)
}
...
func (queue *X1StringQueue) Push(items ...string) *X1StringQueue {
...
func (queue *X1StringQueue) Offer(items ...string) []string {
	return queue.doPush(items...)
}

func (queue *X1StringQueue) doPush(items ...string) []string {
	n := len(items)
...
func (queue *X1StringQueue) Pop1() (string, bool) {
...
func (queue *X1StringQueue) Pop(n int) []string {
	return queue.doPop(n)
}

func (queue *X1StringQueue) doPop(n int) []string {
	if queue.length == 0 {
		return nil
	}
...
func (queue *X1StringQueue) Contains(v string) bool {
...
func (queue *X1StringQueue) ContainsAll(i ...string) bool {
	if queue == nil {
		return len(i) == 0
	}
...
// Exists verifies that one or more elements of X1StringQueue return true for the predicate p.
// The function should not alter the values via side-effects.
func (queue *X1StringQueue) Exists(p func(string) bool) bool {
	if queue == nil {
		return false
	}
...
// Forall verifies that all elements of X1StringQueue return true for the predicate p.
// The function should not alter the values via side-effects.
func (queue *X1StringQueue) Forall(p func(string) bool) bool {
	if queue == nil {
		return true
	}
...
// Foreach iterates over X1StringQueue and executes function f against each element.
// The function can safely alter the values via side-effects.
func (queue *X1StringQueue) Foreach(f func(string)) {
	if queue == nil {
		return
	}
...
func (queue *X1StringQueue) Send() <-chan string {
	ch := make(chan string)
	go func() {
		if queue != nil {
...
// DoKeepWhere modifies a X1StringQueue by retaining only those elements that match
...
func (queue *X1StringQueue) DoKeepWhere(p func(string) bool) *X1StringQueue {
	if queue == nil {
		return nil
	}
...
func (queue *X1StringQueue) Find(p func(string) bool) (string, bool) {
	if queue == nil {
		return "", false
	}
...
// Filter returns a new X1StringQueue whose elements return true for predicate p.
//
// The original queue is not modified. See also DoKeepWhere (which does modify the original queue).
func (queue *X1StringQueue) Filter(p func(string) bool) *X1StringQueue {
	if queue == nil {
		return nil
	}

	result := NewX1StringSortedQueue(queue.length, queue.overwrite, queue.less)
	i := 0
...
// Partition returns two new X1StringQueues whose elements return true or false for the predicate, p.
// The first result consists of all elements that satisfy the predicate and the second result consists of
// all elements that don't. The relative order of the elements in the results is the same as in the
// original queue.
//
// The original queue is not modified
func (queue *X1StringQueue) Partition(p func(string) bool) (*X1StringQueue, *X1StringQueue) {
	if queue == nil {
		return nil, nil
	}

	matching := NewX1StringSortedQueue(queue.length, queue.overwrite, queue.less)
	others := NewX1StringSortedQueue(queue.length, queue.overwrite, queue.less)
	m, o := 0, 0
...
// Map returns a new X1StringQueue by transforming every element with function f.
// The resulting queue is the same size as the original queue.
// The original queue is not modified.
//
// This is a domain-to-range mapping function. For bespoke transformations to other types, copy and modify
// this method appropriately.
func (queue *X1StringQueue) Map(f func(string) string) *X1StringQueue {
	if queue == nil {
		return nil
	}
...
// FlatMap returns a new X1StringQueue by transforming every element with function f that
// returns zero or more items in a slice. The resulting queue may have a different size to the original queue.
// The original queue is not modified.
//
// This is a domain-to-range mapping function. For bespoke transformations to other types, copy and modify
// this method appropriately.
func (queue *X1StringQueue) FlatMap(f func(string) []string) *X1StringQueue {
	if queue == nil {
		return nil
	}
...
// CountBy gives the number elements of X1StringQueue that return true for the predicate p.
func (queue *X1StringQueue) CountBy(p func(string) bool) (result int) {
	if queue == nil {
		return 0
	}
...
func (queue *X1StringQueue) Fold(initial string, fn func(string, string) string) string {
	if queue == nil {
		return initial
	}
...
// MinBy returns an element of X1StringQueue containing the minimum value, when compared to other elements
// using a passed func defining ‘less’. In the case of multiple items being equally minimal, the first such
// element is returned. Panics if there are no elements.
func (queue *X1StringQueue) MinBy(less func(string, string) bool) string {
...
// MaxBy returns an element of X1StringQueue containing the maximum value, when compared to other elements
// using a passed func defining ‘less’. In the case of multiple items being equally maximal, the first such
// element is returned. Panics if there are no elements.
func (queue *X1StringQueue) MaxBy(less func(string, string) bool) string {
...
func (queue *X1StringQueue) Equals(other *X1StringQueue) bool {
	if queue == nil {
		if other == nil {
			return true
		}
...
func (queue *X1StringQueue) StringList() []string {
...
func (queue *X1StringQueue) String() string {
	return queue.MkString3("[", ", ", "]")
}

// MkString concatenates the values as a string using a supplied separator. No enclosing marks are added.
func (queue *X1StringQueue) MkString(sep string) string {
	return queue.MkString3("", sep, "")
}

// MkString3 concatenates the values as a string, using the prefix, separator and suffix supplied.
func (queue *X1StringQueue) MkString3(before, between, after string) string {
	if queue == nil {
		return ""
	}
...
func (queue X1StringQueue) mkString3Bytes(before, between, after string) *strings.Builder {
	b := &strings.Builder{}
...
func (queue *X1StringQueue) UnmarshalJSON(b []byte) error {

	return json.Unmarshal(b, &queue.m)
}

// MarshalJSON implements JSON encoding for this queue type.
func (queue X1StringQueue) MarshalJSON() ([]byte, error) {
