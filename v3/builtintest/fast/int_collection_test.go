...
func TestNewXIntCollection(t *testing.T) {
	...
	testEmptyIntCollection(t, NewX1IntQueue(5, false), "Queue")
}
...
func TestIntToSlice(t *testing.T) {
	...
	testIntToSlice(t, interestingFullQueue(1, 2, 3), "Queue")
	testIntToSlice(t, interestingPartialQueue(1, 2, 3), "Queue")
}
...
func TestIntExists(t *testing.T) {
	...
	testIntExists1(t, interestingFullQueue(1, 2, 3), "Queue")
	testIntExists1(t, interestingPartialQueue(1, 2, 3), "Queue")
}
...
func TestIntForall(t *testing.T) {
	...
	testIntForall(t, interestingFullQueue(1, 2, 3), "Queue")
	testIntForall(t, interestingPartialQueue(1, 2, 3), "Queue")
}
...
func TestIntFind(t *testing.T) {
	...
	testIntFind(t, interestingFullQueue(1, 2, 3), "Queue")
	testIntFind(t, interestingPartialQueue(1, 2, 3), "Queue")
}
...
func TestIntCountBy(t *testing.T) {
	...
	testIntCountBy(t, interestingFullQueue(1, 2, 3), "Queue")
	testIntCountBy(t, interestingPartialQueue(1, 2, 3), "Queue")
}
...
func TestIntForeach(t *testing.T) {
	...
	testIntForeach(t, interestingFullQueue(1, 2, 3), "Queue")
	testIntForeach(t, interestingPartialQueue(1, 2, 3), "Queue")
}
...
func TestIntContains(t *testing.T) {
	...
	testIntContains(t, interestingFullQueue(71, 1, 7, 13), "Queue")
	testIntContains(t, interestingPartialQueue(71, 1, 7, 13), "Queue")
}
...
func TestIntMinMaxSum(t *testing.T) {
	...
	testIntMinMaxSum(t, interestingFullQueue(10, 71, 3, 7, 13), "Queue")
	testIntMinMaxSum(t, interestingPartialQueue(10, 13, 3, 7, 71), "Queue")
	testIntMinMaxSum(t, interestingPartialQueue(10, 71, 3, 7, 13), "Queue")
}
...
func TestIntSend(t *testing.T) {
	...
	testIntSend(t, interestingFullQueue(10, 71, 3, 7, 13), "Queue")
	testIntSend(t, interestingPartialQueue(10, 71, 3, 7, 13), "Queue")
}
...
func TestIntStringer(t *testing.T) {
	...
	testIntStringer(t, interestingFullQueue(10, 71, 3, 7, 13), true, "Queue")
	testIntStringer(t, interestingPartialQueue(10, 71, 3, 7, 13), true, "Queue")
}
